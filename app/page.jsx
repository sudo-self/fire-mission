...
import { Book, Target, Calendar, Plus, Layout, Grid, Crown } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {filteredNotes.length === 0 && !loading && !showForm && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-2">No {filter !== 'all' ? filter + 's' : 'items'} yet</h3>
